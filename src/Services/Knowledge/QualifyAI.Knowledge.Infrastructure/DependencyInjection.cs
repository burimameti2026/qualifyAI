...
public static class DependencyInjection
{
    ...
    {
        services.AddDbContext<KnowledgeDbContext>(o => o.UseSqlServer(configuration.GetConnectionString("KnowledgeDb")));
        ...
        services.AddSingleton(sp => sp.GetRequiredService<IMongoDatabase>().GetCollection<KnowledgeChunkDocument>("knowledge_chunks"));
