...
namespace QualifyAI.Identity.Infrastructure.Persistence.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    PlatformOnly = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RolePermissionGrants_AccessRoles_RoleId",
                        column: x => x.RoleId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClientPermissionGrants", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ClientPermissionGrants_ClientApplications_ClientApplicationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccessRoles_TenantId_NormalizedName",
                table: "AccessRoles",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClientPermissionGrants_ClientApplicationId_Permission",
                table: "ClientPermissionGrants",
                columns: new[] { "ClientApplicationId", "Permission" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ClientScopes_ClientApplicationId_Name",
                table: "ClientScopes",
                columns: new[] { "ClientApplicationId", "Name" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_LicenseModules_LicenseId_Code",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RolePermissionGrants_RoleId_Permission",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SecurityAuditEntries_TenantId_OccurredAtUtc",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserPermissions_TenantId_UserId_Permission",
