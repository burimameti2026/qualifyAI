...
namespace QualifyAI.Persistence.SqlServer.Migrations
{
    public partial class SyncPlatformModelAfterAutonomousAcquisitionAndProvisioning : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            // BillingEvents is owned by EnsureBillingSchemaAsync(), which already supports existing databases.
            // Do not create it here or EF migrations will conflict with the billing schema bootstrap.

            migrationBuilder.CreateTable(name: "TenantModuleProvisionings", columns: table => new { Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false), TenantId = table.Column<Guid>(type: "uniqueidentifier", nullable: false), Module = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false), Status = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false), ProvisionedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: true), CreatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false), UpdatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false) }, constraints: table => table.PrimaryKey("PK_TenantModuleProvisionings", x => x.Id));
