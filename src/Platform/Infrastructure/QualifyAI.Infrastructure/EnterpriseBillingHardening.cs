...
public sealed class StripeBillingProvider(IBillingEventProcessor processor) : IBillingProviderAdapter
{
    ...
    public bool CanHandle(string eventType) => eventType.StartsWith("customer.subscription",StringComparison.OrdinalIgnoreCase) || eventType.StartsWith("invoice.",StringComparison.OrdinalIgnoreCase) || eventType.StartsWith("payment_intent.",StringComparison.OrdinalIgnoreCase);
