    ...
    : IProspectDiscoveryProvider
{
    ...
    private string? ApiKey =>
        ...
        ?? configuration["ProspectDiscovery__SerpApi__ApiKey"]
        ?? Environment.GetEnvironmentVariable("ProspectDiscovery__SerpApi__ApiKey")
    ...
    private static int? ParseEnvironmentLimit()
    {
        var value = Environment.GetEnvironmentVariable("SERPAPI_LIMIT")
            ?? Environment.GetEnvironmentVariable("ProspectDiscovery__SerpApi__MonthlySafetyLimit");
