...
namespace LeadsAI.Infrastructure.It;
    ...
    public async Task<bool> SeedAsync(Guid tenantId, CancellationToken cancellationToken = default)
    {
        ...
        var products = new[]
        {
            new CatalogProduct
            {
                ...
                Description = "Sample product for the Renova LeadsAI demonstration. Designed for interior finishing projects and professional applicators.",
