...
public static class DependencyInjection
{
    public static IServiceCollection AddBusinessInfrastructure(this IServiceCollection services, IConfiguration configuration, bool allowDevelopmentModelDrift = false)
    {
        ...
        services.AddScoped<IAiProvider>(sp => sp.GetRequiredService<OllamaAiProvider>());
        ...
        services.AddScoped<IAiTool, CreateTargetListTool>();
        services.AddScoped<IAiTool, CreateCampaignTool>();
        services.AddScoped<IAiTool, StartCampaignTool>();
        services.AddScoped<IAiTool, RunAutonomousAcquisitionTool>();
