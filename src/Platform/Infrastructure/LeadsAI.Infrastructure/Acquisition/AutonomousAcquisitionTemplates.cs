...
public sealed class AutonomousAcquisitionTemplateRegistry : IAutonomousAcquisitionTemplateRegistry
{
 ...
 {
  new("fleet","Fleet Management — FusionFleet","Fleet & Mobility","Europe",["fleet management","commercial vehicle fleet","vehicle operations","transport fleet","telematics"],["fleet","vehicles","logistics","transport","mobility"],90),
  new("renova","Renova","Construction Materials & Building Supply","Balkans",["building material distributors","construction material wholesalers","plaster distributors","facade system distributors","construction companies","building supply"],["plaster","putz","render","facade","building materials","construction supply","adhesive","primer"],75),
  new("hospital","Hospital Management System","Healthcare & Hospital Management","Europe",["hospitals","private hospitals","hospital groups","medical centers","healthcare networks","clinics"],["hospital","clinic","healthcare","medical center","hospital group","digital health","health IT","healthcare software"],85),
