using LeadsAI.AIOrchestration.Application.Tools;

namespace LeadsAI.AIOrchestration.Infrastructure.Tools.Logistics;

public sealed class RequestFreightQuoteTool : IAgentTool
{
