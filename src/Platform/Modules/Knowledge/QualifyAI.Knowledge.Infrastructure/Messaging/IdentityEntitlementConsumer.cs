...
using QualifyAI.Knowledge.Persistence.SqlServer;

namespace QualifyAI.Knowledge.Infrastructure.Messaging;

public sealed class IdentityEntitlementConsumer(KnowledgeDbContext db) :
...
{
    private const string ConsumerName = "knowledge.identity-entitlements";
