...
public class BrandingProfile : TenantEntity { public string ProductName { get; set; }="LeadsAI"; public string LogoUrl { get; set; }=""; public string PrimaryColor { get; set; }="#2563EB"; public string AccentColor { get; set; }="#0F172A"; public string SupportEmail { get; set; }=""; }
