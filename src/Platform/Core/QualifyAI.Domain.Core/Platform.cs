...
public class Notification : TenantEntity { public Guid? UserId { get; set; } public string Title { get; set; }=""; public string Body { get; set; }=""; public bool IsRead { get; set; } public string Message { get; set; }=""; public string Type { get; set; }=""; }
